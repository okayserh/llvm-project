//===-- T8XX   implementation of memory function building blocks ----------===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_LIBC_SRC_STRING_MEMORY_UTILS_OP_T8XX_H
#define LLVM_LIBC_SRC_STRING_MEMORY_UTILS_OP_T8XX_H

#include "src/__support/macros/attributes.h" // LIBC_INLINE
#include "src/__support/macros/config.h"     // LIBC_NAMESPACE_DECL
#include "src/__support/macros/properties/architectures.h"

#if defined(LIBC_TARGET_ARCH_IS_T8XX)
...
#endif // LIBC_TARGET_ARCH_IS_T8XX
#endif // LLVM_LIBC_SRC_STRING_MEMORY_UTILS_OP_T8XX_H
