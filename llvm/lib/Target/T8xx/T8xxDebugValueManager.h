...
#ifndef LLVM_LIB_TARGET_T8XX_T8XXDEBUGVALUEMANAGER_H
#define LLVM_LIB_TARGET_T8XX_T8XXDEBUGVALUEMANAGER_H
...
public:
  T8xxDebugValueManager(MachineInstr *Def);
